...
<head>
    ...
    <title>Edit Product - Vendora | Jimma, Ethiopia</title>
        ...
        <header class="top-header">
            <div style="display: flex; align-items: center; gap: 16px;">
                ...
                <div class="page-title">
                    <i class="ri-edit-line" style="color: var(--primary-gold);"></i> Edit Product
                </div>
            </div>
        ...
        <div class="dashboard-container">
            ...
            <div class="page-header">
                ...
                <div style="display: flex; gap: 12px;">
                    <a href="{{ route('vendor.products.show', $product->id) }}" class="btn btn-secondary">
            ...
            <div class="form-container">
                <form action="{{ route('vendor.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="productForm">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; align-items: center;">
                                ...
                                <span class="toggle-label" id="statusLabel">
                                    {{ (old('is_active', $product->is_active ?? $product->status ?? true)) ? 'Active' : 'Inactive' }}
                                </span>
                            </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="form-hint">To delete images, you can remove the product and re-upload new ones.</div>
                        </div>
                        @endif
                ...
                <!-- Delete Form (separate for safety) -->
                <div style="margin-top: 20px; padding-top: 20px; border-top: 2px solid var(--border-color);">
                    <form action="{{ route('vendor.products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this product? This action cannot be undone.');">
                        @csrf
                        @method('DELETE')
