...
<head>
    ...
    <title>Vendora - Categories Management</title>
        ...
        <div class="dashboard-container">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-number">{{ number_format($categories->total() ?? 0) }}</div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-number">{{ number_format($categories->where('is_active', true)->count() ?? 0) }}</div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-number">{{ number_format($categories->sum('products_count') ?? 0) }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3 class="table-title">Categories List</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="category-name">
                                    <div class="category-icon" style="background-color: {{ ['#3b82f6', '#10b981', '#f59e0b', '#8b5cf6', '#ef4444', '#B88E3F'][rand(0,5)] }};">
                                        <i class="ri-price-tag-line"></i>
                                    </div>
                                    <div>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="#" class="action-btn" title="Edit Category">
                                        <i class="ri-edit-line"></i>
                                    </a>
                                    <a href="#" class="action-btn" title="View Products">
                                        <i class="ri-eye-line"></i>
                                    </a>
                                    <a href="#" class="action-btn" title="Delete Category" onclick="return confirm('Are you sure you want to delete this category?')">
                        ...
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 60px;">
                                ...
                                <p style="color: var(--text-secondary);">Get started by creating your first category</p>
                                <a href="#" class="btn btn-primary" style="margin-top: 20px; display: inline-flex;">
                                    <i class="ri-add-line"></i> Add New Category
                                </a>
                            </td>
                        </tr>
